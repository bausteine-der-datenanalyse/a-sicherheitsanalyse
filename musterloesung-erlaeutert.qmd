...
```{r}
if (!file_exists("daten/BFStr_Netz_v2025q4.gpkg")) {
...
d_bfstn <- read_sf("daten/BFStr_Netz_v2025q4.gpkg") |>
...
Den Unterschied des Filters sehen wir im Environment: Der Unfalldatensatz aus 2023 beinhaltet 269.048 Unfälle insgesamt, der Unfalldatensatz für Autobahnen nur noch 22.114. Für mehr Übersichtlichkeit vereinfachen wir unseren Datensatz und lassen uns mit "select" nur bestimmte Spalten anzeigen.
